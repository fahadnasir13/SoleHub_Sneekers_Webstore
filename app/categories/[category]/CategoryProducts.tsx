    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="flex items-center text-sm text-gray-600 mb-8">
          ...
          <span className="mx-2">→</span>
          <span className="text-black">{categoryDisplayName}</span>
        </div>

        {/* Category Header */}
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-black mb-4">{categoryDisplayName} Sneakers</h1>
          <p className="text-xl text-gray-600 mb-2">
            Discover premium {categoryDisplayName.toLowerCase()} sneakers from top brands
          </p>
        ...
        {sortedProducts.length > 0 ? (
          ...
          <div className="text-center py-16">
            ...
            <p className="text-gray-600 mb-6">No products available in this category at the moment.</p>
            <Link href="/products">
